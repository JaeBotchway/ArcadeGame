...
var x = window.prompt("Enter number of tries");
var WINNINGscore = x;
...
window.onload = function () 
{
    ...
    canvas.addEventListener('mousemove', function (evt)
     {                                                                                //this function calls calcaulateMousePos, and paddleY moves in direction of mouse
...
function ballReset()
 {
    if (Player1Score >= WINNINGscore ||
        ...
        {
            WinScreen =true;                                    //function reset ball direction or position
        }
    ...
    function drawEverything()
     {  
        ...
        if(WinScreen)
        {
            ...
            if (Player1Score >= WINNINGscore)
            {
                canvasContext.fillText("Player1 won", 300, 200);
            } else if
                (Player2Score >= WINNINGscore)
                {
                  canvasContext.fillText("Player2 won", 300, 200);
                }
